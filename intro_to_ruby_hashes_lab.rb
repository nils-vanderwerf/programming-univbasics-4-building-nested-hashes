...
def monopoly_with_third_tier
  ...
  # Updating "Rent in dollars" key
  monopoly[:railroads][:rent_in_dollars][:one_piece_owned] = 25

  monopoly[:railroads][:rent_in_dollars][:two_pieces_owned] = 
  monopoly[:railroads][:rent_in_dollars][:one_piece_owned] * 2

  monopoly[:railroads][:rent_in_dollars][:three_pieces_owned] = 
  monopoly[:railroads][:rent_in_dollars][:two_pieces_owned] * 2

  monopoly[:railroads][:rent_in_dollars][:four_pieces_owned] = 
  monopoly[:railroads][:rent_in_dollars][:three_pieces_owned] * 2
